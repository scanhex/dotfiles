return {
    ...
    keys = {
        ...
        { "<leader>ob", "<cmd>CMakeBuild<CR>",              { noremap = true, silent = true } },
        { "<leader>oS", "<cmd>CMakeSelectBuildTarget<CR>",  { noremap = true, silent = true } },
        { "<leader>os", "<cmd>CMakeSelectLaunchTarget<CR>", { noremap = true, silent = true } },
        { "<leader>ov", "<cmd>CMakeSelectBuildType<CR>",    { noremap = true, silent = true } },
    },
    init = function()
        local loaded = false
    ...
    config = function()
        require("cmake-tools").setup {
            ...
            --       ${kitGenerator}
            --       ${variant:xx}
            cmake_build_directory = "build/linux-gnu.release",
